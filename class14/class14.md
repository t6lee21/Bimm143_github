...
load up `DESeq2` to use for today’s lab and download the files we will
use
...
this type of data that we introduced last day.

``` r
plot( res$log2FoldChange, -log(res$padj) )
```

![](class-14_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](class-14_files/figure-commonmark/unnamed-chunk-8-1.png)
